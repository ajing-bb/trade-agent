...
> Generated from `character-bible.yaml`. Do not edit this Markdown manually.
...
| `CHAR_LINQIANQIAN` | 林倩倩 | female academy student, ex-girlfriend | 待设计 | beauty with superiority、visible class selection instinct、can shift from public disdain to startled reaction | `assets/只有我能抽出东方神明/角色/CHAR_LINQIANQIAN/` |
| `CHAR_ZHANGHE` | 张贺 | male rich academy student rival | 待设计 | rich elite academy presence、dismissive body language、visually opposite to Mengjiang's restrained underdog look | `assets/只有我能抽出东方神明/角色/CHAR_ZHANGHE/` |

## 当前角色资产说明

- 首轮先锁孟江，再补齐学院公开抽卡仪式相关 speaking cast。
- status 约定：planned=已入 canon 未进入当前轮主攻，prompted=已纳入当前轮提示词，committed=已有仓库落盘母资产。
